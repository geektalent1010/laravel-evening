              ...
              <table class="table datatables" id="myDataTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="padding:0.2rem;">{{$data->color}}</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="varyModalLabel">色マスタ</h5>
      ...
      <div class="modal-body">
        <form>
          <input type="hidden" id="upd_color_id">
          <div class="form-group">
            <label for="upd_color" class="col-form-label">色名:</label>
            <input type="text" class="form-control" id="upd_color">
          </div>
        </form>
      </div>
...
<script type="text/javascript">
  ...
  function editData(record_id){
    ...
    $("#upd_color_id").val(data.id);
    $("#upd_color").val(data.color);
  }
  ...
  function saveData(){
    var color_id = $("#upd_color_id").val();
    var color = $("#upd_color").val();
