              ...
              <table class="table datatables" id="myDataTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="padding:0.2rem;">{{$data->role}}</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          <input type="hidden" id="upd_depart_id">
          <div class="form-group">
            <label for="upd_depart" class="col-form-label">事業所:</label>
            <input type="text" class="form-control" id="upd_depart">
          </div>
          <div class="form-group">
            <label for="upd_role" class="col-form-label">権限:</label>
            <select class="form-control select2" id="upd_role">
...
<script type="text/javascript">
  ...
  function editData(record_id){
    ...
    $("#upd_depart_id").val(data.id);
    $("#upd_depart").val(data.depart);
    $("#upd_role").val(data.role);
  }
  ...
  function deleteData(record_id){
    ...
    $.ajax({
        type: "POST",
        url: 'depart/deletedata',
        data: {
            depart_id : record_id,
        },
        dataType: 'json',
        success: function (data) {
          window.location.href = "{{url('/admin/depart')}}";
        },
        error: function (data) {
            console.log(data);
        }
  ...
  function saveData(){
    var depart_id = $("#upd_depart_id").val();
