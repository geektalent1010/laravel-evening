              ...
              <table class="table datatables" id="myDataTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="padding:0.2rem;">{{$data->maker_name}}</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="varyModalLabel">メーカーマスタ</h5>
      ...
      <div class="modal-body">
        <form>
          <input type="hidden" id="upd_maker_id">
          <div class="form-group">
            <label for="upd_maker_name" class="col-form-label">メーカー名:</label>
            <input type="text" class="form-control" id="upd_maker_name">
          </div>
        </form>
      </div>
...
<script type="text/javascript">
  ...
  function editData(record_id){
    ...
    $("#upd_maker_id").val(data.id);
    $("#upd_maker_name").val(data.maker_name);
  }
  ...
  function deleteData(record_id){
    ...
    $.ajax({
        type: "POST",
        url: 'maker/deletedata',
        data: {
            maker_id : record_id,
        },
        dataType: 'json',
        success: function (data) {
          window.location.href = "{{url('/admin/maker')}}";
        },
        error: function (data) {
            console.log(data);
        }
  ...
  function saveData(){
    var maker_id = $("#upd_maker_id").val();
    var maker_name = $("#upd_maker_name").val();
