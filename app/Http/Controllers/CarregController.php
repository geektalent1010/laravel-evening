...
class CarregController extends Controller
{
    public function index()
    {
        ...
        return view('carreg.index', compact('title', 'billdepart_list', 'shipper_list', 'yard_list', 'maker_list', 'cartype_list', 'color_list'));
    }
}
